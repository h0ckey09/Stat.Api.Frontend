...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (authModule && googleButtonRef.current) {
      authModule.renderGoogleLogin(googleButtonRef.current, {
        theme: 'outline',
        size: 'large',
        text: 'signin_with'
      }).catch((err) => {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '80vh' }}>
      <div className="card shadow" style={{ width: '100%', maxWidth: '400px', padding: '2rem' }}>
        ...
        <div className="text-center mb-3">
          <p className="text-muted">Sign in with your Google account to access STAT Research</p>
        </div>

        {/* Google Sign-In Button Container */}
        <div ref={googleButtonRef} className="d-flex justify-content-center mb-3"></div>
